...
public class Browser {
    ...
    public static String downloadFilepath = System.getProperty("user.dir").replace("\\", "/") + "/src/main/resources/downloads/";
    ...
    public static WebElement findElement(By by) throws WebDriverException {
        ...
        while (i != searchLoop && element == null) {
            i += 1;
            try {
                element = new WebDriverWait(getDriver(), 10).ignoring(StaleElementReferenceException.class).until(ExpectedConditions.presenceOfElementLocated(by));
            } catch (Exception e) {
                element = null;
            }
        }
    ...
    public static List<WebElement> findElements(By by) throws WebDriverException {
        ...
        while (i != searchLoop && elements.size() == 0) {
            i += 1;
            try {
                elements = new WebDriverWait(getDriver(), 5).ignoring(StaleElementReferenceException.class).until(ExpectedConditions.presenceOfAllElementsLocatedBy(by));
            } catch (Exception e) {
                elements = null;
            }
        }
    ...
    public static List<WebElement> findElements(By parentBy, By childBy) throws WebDriverException {
        ...
        while (i != searchLoop && elements.size() == 0) {
            i += 1;
            try {
                element = new WebDriverWait(getDriver(), 5).ignoring(StaleElementReferenceException.class).until(ExpectedConditions.presenceOfElementLocated(parentBy));
    ...
    public static void getBrowser(String chooseBrowser) throws Exception {
        fileInputStream = new FileInputStream(System.getProperty("user.dir").replace("\\", "/") + "/src/main/resources/AppConfig/config.properties");
    ...
    public static void openBrowser() throws Exception {
        ...
        if (browser.equalsIgnoreCase("chrome")) {
            ...
            if (chromeProfile.equals("true")) {
                ...
                chromeOptions.addArguments("disable-infobars", "--disable-web-security", "--no-proxy-server", "--incognito", "--disable-gpu");
                ...
                Log.testStep("INFO", "Browser used is : " + chromeCapabilities.getBrowserName().toString(), chromeCapabilities.getBrowserName().toString());
            ...
            System.setProperty(FirefoxDriver.SystemProperty.BROWSER_LOGFILE, System.getProperty("user.dir").replace("\\", "/") + "marionette_logs.txt");
            ...
            Log.testStep("INFO", "Browser used is : " + firefoxCapabilities.getBrowserName().toString(), firefoxCapabilities.getBrowserName().toString());
        ...
        Log.setLog("Start automation test in " + browser.replace("grid_", "") + " with Dimensions: " + getDriver().manage().window().getSize());
    }
    ...
    public static void setEnvironment() throws Exception {
        ...
        if (environment.equals("dev")) {
            Log.testStep("INFO", "Setting the environment to " + environment, "Setting the environment to " + environment);
